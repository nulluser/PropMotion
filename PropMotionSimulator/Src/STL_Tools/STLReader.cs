            ...
            if (fileBytes.Length > 120)
            {
                ...
                for(i = 0; i < numOfMesh; i++)
                {
                    ...
                    try
                    {
                        ...
                        float len = (float)Math.Sqrt( newMesh.normal1.X* newMesh.normal1.X +  newMesh.normal1.Y* newMesh.normal1.Y +  newMesh.normal1.Z* newMesh.normal1.Z);

                        newMesh.normal1.X /= len;
                        newMesh.normal1.Y /= len;
                        newMesh.normal1.Z /= len;
